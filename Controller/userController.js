...
const generateResetToken = asyncErrorHandler(async (req,res, next)=>{
    ...
    const resetUri = `${req.protocol}://${req.get("host")}/api/v1/password/reset/${resetToken}`;
...
export {getAllUser,getUser,updateRole,deleteUSer,registerUser, updateProfile, loginUser, logout, generateResetToken, resetPassword, getMyDetails, updatePassword};